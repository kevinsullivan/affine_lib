...
/-instance : distrib_mul_action K (aff_coord_vec X K V n ι fr) := 
    sorry-/
variables (f : affine_frame (aff_pt_coord_tuple ℝ 3) ℝ (aff_vec_coord_tuple ℝ 3) (fin 3))

instance : distrib_mul_action 
    ℝ 
    (aff_coord_vec (aff_pt_coord_tuple ℝ 3) ℝ (aff_vec_coord_tuple ℝ 3) 3 (fin 3) 
    f) := 
    sorry
noncomputable instance affsemi : semimodule ℝ 
    (aff_coord_vec (aff_pt_coord_tuple ℝ 3) ℝ (aff_vec_coord_tuple ℝ 3) 3 (fin 3) 
    f) := ⟨sorry, sorry⟩
distrib_mul_action ℝ (aff_coord_vec (aff_pt_coord_tuple ℝ 3) ℝ (aff_vec_coord_tuple ℝ 3) 3 (fin 3) f)
